...
import { loadAllBookingHistory, loadBookings, loadDeployedBookings, notofyOverdue } from '../components/composables/booking-composables';
...
const fetch = async () => {
  loading.value = true
  const { data, load, totalBookings } = loadAllBookingHistory(params.value);
  await load();
