<template>
  ...
  <VerifyUserModal v-if="!loading" :open-modal="showVerifyModal" :selected-book="userProfile" @closeModal="handleCloseAddVehicleModal"
...
import VerifyUserModal from '../modals/VerifyUserModal.vue';
