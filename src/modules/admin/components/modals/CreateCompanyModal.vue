...
const emit = defineEmits(['closeModal', 'saveCompany', 'updateCompany'])
...
const handleUpdateCompany = async () => {
    ...
    if(!loading.value && !errorValue.value, !errorData.value) {
        emit('updateCompany', data.value)
    }
}

const handleStoreCompany = async () => {
                                ...
                                <form>
                                    <div class="overflow-hidden shadow sm:rounded-md">
                                        ...
                                        <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
                                            <button @click.prevent="handleStoreCompany" :disabled="loading"
