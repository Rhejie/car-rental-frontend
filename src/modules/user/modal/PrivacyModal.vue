                        ...
                        <DialogPanel
                            ...
                            <div>
                                <div class="mx-auto flex text-center h-12 w-12 items-center rounded-full bg-green-100">
                                    <EyeSlashIcon class="h-6 w-6 mx-auto text-green-600" aria-hidden="true" />
                                </div>
                                <div class=" sm:mt-5">
                                    <DialogTitle as="h3"
                                        class="text-lg mt-3 text-center font-medium leading-6 text-gray-900">
                                        Privacy Policy
                                    </DialogTitle>
                                    <div class="mt-2">
                                        <p>
                                            We are APC Car Rental, APC Car Rental is Panabo City most distinguished
                                            rental Car Company.
                                            We provide customers with approximately 50 locations and 100 vehicles
                                            throughout Mindanao.
                                            As we are not affiliated with any specific automaker, we are able to provide
                                            a variety of vehicle makes and models for customers to rent.
                                        </p>
                                    </div>
                                </div>
                            </div>
